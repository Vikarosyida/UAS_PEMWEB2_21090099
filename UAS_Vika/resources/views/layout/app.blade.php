    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="{{route('home')}}" class="brand-link">
                ...
                <span class="brand-text font-weight-light">Mahasiswa Berprestasi</span>
            </a>
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{ asset('images/user1.png') }}" class="img-circle elevation-2" alt="User Image">
                    </div>
                    <div class="info">
        ...
        <footer class="main-footer d-print-none">
            <div class="float-right d-none d-sm-block">
                Designed by <a href="https://www.instagram.com/xyvkrsyd/">Vika</a>
            </div>
            <strong>Copyright &copy; {{ date('Y') }} Vika Rosyida | 21090099 </strong> All rights reserved.
        </footer>
